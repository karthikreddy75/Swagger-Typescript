...
export interface SwaggerResponse {
    $ref?: string;
    description?: string;
    content?: Partial<Record<ApiAST["contentType"], Pick<Schema, "example" | "examples"> & {
        schema?: Schema;
    }>>;
}
...
export type ApiAST = {
    contentType: "*/*" | "text/json" | "application/json" | "application/octet-stream" | "application/json-patch+json" | "application/*+json" | "multipart/form-data" | "application/x-www-form-urlencoded";
